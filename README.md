[*GAMPANG RICO, NIH LANGSUNG COPAS SEKALI JADI:*

*1. KOSONGIN DULU FILE LU*
Di halaman edit `README.md` Github → *Pencet `Ctrl+A`* → *Pencet `Delete`* → Kosong total

*2. COPY BLOK INI, PASTE 1X AJA*
...
**3. COMMIT**
Scroll bawah → Commit message: `docs: fix duplicate README content` → **Pencet `Commit changes`**

**UDAH ITU DOANG.** Dijamin rapi, badge muncul, ga double lagi. 
**Kalo masih double berarti lu paste 2x RICO** 😂 

**Gas coba sekarang, SS hasil `Preview` kalo udah** 🔥](https://img.shields.io/badge/License-Apache_2.0-blue.svg](https://opensource.org/licenses/Apache-2.0)
